//
//  GroqChatCompletionRequestSystemMessageContent.swift
//  HyperProxySwift
//
...
public enum GroqChatCompletionRequestSystemMessageContent: Codable, Sendable {
  case string(String)
...
extension GroqChatCompletionRequestSystemMessageContent: ExpressibleByStringLiteral {
  public init(stringLiteral value: String) {
    self = .string(value)
  }
}

extension GroqChatCompletionRequestSystemMessageContent: ExpressibleByArrayLiteral {
