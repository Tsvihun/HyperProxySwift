//
//  EachAIAPIPredictionOutput.swift
//  HyperProxySwift
//
...
public enum EachAIAPIPredictionOutput: Codable, Sendable {
  case string(String)
...
extension EachAIAPIPredictionOutput: ExpressibleByStringLiteral {
  public init(stringLiteral value: String) {
    self = .string(value)
  }
}

extension EachAIAPIPredictionOutput: ExpressibleByArrayLiteral {
