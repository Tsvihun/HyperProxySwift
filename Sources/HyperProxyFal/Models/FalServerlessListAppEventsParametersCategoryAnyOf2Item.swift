//
//  FalServerlessListAppEventsParametersCategoryAnyOf2Item.swift
//  HyperProxySwift
//
...
public enum FalServerlessListAppEventsParametersCategoryAnyOf2Item: String, Codable, Hashable,
  Sendable
{
