//
//  FalUnfavoriteAssetCharacterResponseCharacter.swift
//  HyperProxySwift
//
...
public struct FalUnfavoriteAssetCharacterResponseCharacter: Codable, Sendable {
  ...
  public var kind: FalUnfavoriteAssetCharacterResponseCharacterKind
  ...
  public init(
    ...
    kind: FalUnfavoriteAssetCharacterResponseCharacterKind,
    updatedAt: String,
