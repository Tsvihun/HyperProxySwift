//
//  MistralActivityTaskStartedResponse.swift
//  HyperProxySwift
//
...
public struct MistralActivityTaskStartedResponse: Codable, Sendable {
  ...
  public var eventType: MistralACTIVITYTASKSTARTEDEventType
  ...
  public init(
    ...
    eventType: MistralACTIVITYTASKSTARTEDEventType = .aCTIVITYTASKSTARTED
  ) {
