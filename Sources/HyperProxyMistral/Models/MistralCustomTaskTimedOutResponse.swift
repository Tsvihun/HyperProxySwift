//
//  MistralCustomTaskTimedOutResponse.swift
//  HyperProxySwift
//
...
public struct MistralCustomTaskTimedOutResponse: Codable, Sendable {
  ...
  public var eventType: MistralCUSTOMTASKTIMEDOUTEventType
  ...
  public init(
    ...
    eventType: MistralCUSTOMTASKTIMEDOUTEventType = .cUSTOMTASKTIMEDOUT
  ) {
