//
//  MistralAssignGroupToWorkspaceInRoleNamesAnyOf1Item.swift
//  HyperProxySwift
//
...
public enum MistralAssignGroupToWorkspaceInRoleNamesAnyOf1Item: String, Codable, Hashable, Sendable
{
