//
//  MistralAudioTranscriptionRequest.swift
//  HyperProxySwift
//
...
public struct MistralAudioTranscriptionRequest: Codable, Sendable {
  ...
  public var stream: MistralAudioTranscriptionRequestStream0329a7e8?
  ...
  public init(
    ...
    fileUrl: String? = nil,
    language: String? = nil,
    stream: MistralAudioTranscriptionRequestStream0329a7e8? = nil,
