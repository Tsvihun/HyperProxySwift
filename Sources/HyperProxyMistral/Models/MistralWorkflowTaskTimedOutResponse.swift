//
//  MistralWorkflowTaskTimedOutResponse.swift
//  HyperProxySwift
//
...
public struct MistralWorkflowTaskTimedOutResponse: Codable, Sendable {
  ...
  public var eventType: MistralWORKFLOWTASKTIMEDOUTEventType
  ...
  public init(
    ...
    eventType: MistralWORKFLOWTASKTIMEDOUTEventType = .wORKFLOWTASKTIMEDOUT
  ) {
