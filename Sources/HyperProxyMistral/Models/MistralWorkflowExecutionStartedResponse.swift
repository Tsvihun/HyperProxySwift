//
//  MistralWorkflowExecutionStartedResponse.swift
//  HyperProxySwift
//
...
public struct MistralWorkflowExecutionStartedResponse: Codable, Sendable {
  ...
  public var eventType: MistralWORKFLOWEXECUTIONSTARTEDEventType
  ...
  public init(
    ...
    eventType: MistralWORKFLOWEXECUTIONSTARTEDEventType = .wORKFLOWEXECUTIONSTARTED
  ) {
