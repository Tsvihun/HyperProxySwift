//
//  MistralCustomTaskStartedResponse.swift
//  HyperProxySwift
//
...
public struct MistralCustomTaskStartedResponse: Codable, Sendable {
  ...
  public var eventType: MistralCUSTOMTASKSTARTEDEventType
  ...
  public init(
    ...
    eventType: MistralCUSTOMTASKSTARTEDEventType = .cUSTOMTASKSTARTED
  ) {
