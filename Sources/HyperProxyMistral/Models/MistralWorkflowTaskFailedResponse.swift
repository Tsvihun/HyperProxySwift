//
//  MistralWorkflowTaskFailedResponse.swift
//  HyperProxySwift
//
...
public struct MistralWorkflowTaskFailedResponse: Codable, Sendable {
  ...
  public var eventType: MistralWORKFLOWTASKFAILEDEventType
  ...
  public init(
    ...
    eventType: MistralWORKFLOWTASKFAILEDEventType = .wORKFLOWTASKFAILED
  ) {
