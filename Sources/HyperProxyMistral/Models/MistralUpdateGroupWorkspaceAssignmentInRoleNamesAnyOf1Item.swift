//
//  MistralUpdateGroupWorkspaceAssignmentInRoleNamesAnyOf1Item.swift
//  HyperProxySwift
//
...
public enum MistralUpdateGroupWorkspaceAssignmentInRoleNamesAnyOf1Item: String, Codable, Hashable,
  Sendable
{
