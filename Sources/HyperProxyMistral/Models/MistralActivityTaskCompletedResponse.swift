//
//  MistralActivityTaskCompletedResponse.swift
//  HyperProxySwift
//
...
public struct MistralActivityTaskCompletedResponse: Codable, Sendable {
  ...
  public var eventType: MistralACTIVITYTASKCOMPLETEDEventType
  ...
  public init(
    ...
    eventType: MistralACTIVITYTASKCOMPLETEDEventType = .aCTIVITYTASKCOMPLETED
  ) {
