//
//  MistralCustomTaskCanceledResponse.swift
//  HyperProxySwift
//
...
public struct MistralCustomTaskCanceledResponse: Codable, Sendable {
  ...
  public var eventType: MistralCUSTOMTASKCANCELEDEventType
  ...
  public init(
    ...
    eventType: MistralCUSTOMTASKCANCELEDEventType = .cUSTOMTASKCANCELED
  ) {
