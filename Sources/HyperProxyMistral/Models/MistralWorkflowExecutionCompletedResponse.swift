//
//  MistralWorkflowExecutionCompletedResponse.swift
//  HyperProxySwift
//
...
public struct MistralWorkflowExecutionCompletedResponse: Codable, Sendable {
  ...
  public var eventType: MistralWORKFLOWEXECUTIONCOMPLETEDEventType
  ...
  public init(
    ...
    eventType: MistralWORKFLOWEXECUTIONCOMPLETEDEventType = .wORKFLOWEXECUTIONCOMPLETED
  ) {
