//
//  MistralDeltaMessageContent.swift
//  HyperProxySwift
//
...
public enum MistralDeltaMessageContent: Codable, Sendable {
  case string(String)
...
extension MistralDeltaMessageContent: ExpressibleByStringLiteral {
  public init(stringLiteral value: String) {
    self = .string(value)
  }
}

extension MistralDeltaMessageContent: ExpressibleByArrayLiteral {
