//
//  MistralToolMessageContent.swift
//  HyperProxySwift
//
...
public enum MistralToolMessageContent: Codable, Sendable {
  case string(String)
...
extension MistralToolMessageContent: ExpressibleByStringLiteral {
  public init(stringLiteral value: String) {
    self = .string(value)
  }
}

extension MistralToolMessageContent: ExpressibleByArrayLiteral {
