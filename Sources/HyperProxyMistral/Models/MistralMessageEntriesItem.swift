//
//  MistralMessageEntriesItem.swift
//  HyperProxySwift
//
...
public enum MistralMessageEntriesItem: Codable, Sendable {
  ...
  public init(from decoder: any Decoder) throws {
    ...
    self = .messageOutputEntry(try container.decode(MistralMessageOutputEntry.self))
  }
