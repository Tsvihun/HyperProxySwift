//
//  OpenAISessionEventAgentSessionEnvironmentReady.swift
//  HyperProxySwift
//
...
public struct OpenAISessionEventAgentSessionEnvironmentReady: Codable, Sendable {
  ...
  public var kind: OpenAISessionEventAgentSessionEnvironmentReadyKind
  ...
  public init(
    ...
    sessionId: String,
    turnId: String,
    kind: OpenAISessionEventAgentSessionEnvironmentReadyKind
  ) {
