...
public enum OpenAIItemField: Codable, Sendable {
  ...
  public init(from decoder: any Decoder) throws {
    ...
    if let value = try? container.decode(OpenAIMessage.self) {
      self = .message(value)
      return
    }
    ...
    if let value = try? container.decode(OpenAIFunctionToolCallOutput.self) {
      self = .functionToolCallOutput(value)
      return
    }
    ...
    self = .customToolCallOutput(try container.decode(OpenAICustomToolCallOutput.self))
  }
  ...
  public func encode(to encoder: any Encoder) throws {
    ...
    case .additionalTools(let value):
      try container.encode(value)
    case .functionToolCallOutput(let value):
      try container.encode(value)
