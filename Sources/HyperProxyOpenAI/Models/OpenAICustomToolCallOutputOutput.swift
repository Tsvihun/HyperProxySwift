//
//  OpenAICustomToolCallOutputOutput.swift
//  HyperProxySwift
//
...
public enum OpenAICustomToolCallOutputOutput: Codable, Sendable {
  case string(String)
...
extension OpenAICustomToolCallOutputOutput: ExpressibleByStringLiteral {
  public init(stringLiteral value: String) {
    self = .string(value)
  }
}

extension OpenAICustomToolCallOutputOutput: ExpressibleByArrayLiteral {
