//
//  OpenAIBetaModelIdsResponsesAnyOf2.swift
//  HyperProxySwift
//
...
public enum OpenAIBetaModelIdsResponsesAnyOf2: String, Codable, Hashable, Sendable {
  case o1Pro = "o1-pro"
  ...
  case gpt55Pro20260423 = "gpt-5.5-pro-2026-04-23"
