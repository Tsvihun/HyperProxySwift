//
//  OpenAIRealtimeBetaServerEventResponseContentPartAdded.swift
//  HyperProxySwift
//
...
public struct OpenAIRealtimeBetaServerEventResponseContentPartAdded: Codable, Sendable {
  ...
  public var kind: OpenAIRealtimeBetaServerEventResponseContentPartAddedKind
  ...
  public init(
    ...
    responseId: String,
    kind: OpenAIRealtimeBetaServerEventResponseContentPartAddedKind
  ) {
