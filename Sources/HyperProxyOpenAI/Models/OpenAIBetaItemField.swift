...
public enum OpenAIBetaItemField: Codable, Sendable {
  case betaMessage(OpenAIBetaMessage)
  ...
  case betaFunctionToolCallOutput(OpenAIBetaFunctionToolCallOutput)
  ...
  public init(from decoder: any Decoder) throws {
    ...
    if let value = try? container.decode(OpenAIBetaMessage.self) {
      self = .betaMessage(value)
      return
    }
    ...
    if let value = try? container.decode(OpenAIBetaFunctionToolCallOutput.self) {
      self = .betaFunctionToolCallOutput(value)
      return
    }
    ...
    if let value = try? container.decode(OpenAIBetaCustomToolCall.self) {
      self = .betaCustomToolCall(value)
      return
    }
    self = .betaCustomToolCallOutput(try container.decode(OpenAIBetaCustomToolCallOutput.self))
  }

  public func encode(to encoder: any Encoder) throws {
    var container = encoder.singleValueContainer()
    switch self {
    case .betaMessage(let value):
    ...
    case .betaAgentMessage(let value):
      try container.encode(value)
    case .betaFunctionToolCallOutput(let value):
      try container.encode(value)
