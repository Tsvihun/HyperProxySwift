  ...
  Sendable
{
  ...
  public var kind: OpenAIRealtimeServerEventConversationItemInputAudioTranscriptionFailedKind
  ...
  public init(
    ...
    eventId: String,
    itemId: String,
    kind: OpenAIRealtimeServerEventConversationItemInputAudioTranscriptionFailedKind
  ) {
