//
//  OpenAIPredictionContentContent.swift
//  HyperProxySwift
//
...
public enum OpenAIPredictionContentContent: Codable, Sendable {
  case string(String)
...
extension OpenAIPredictionContentContent: ExpressibleByStringLiteral {
  public init(stringLiteral value: String) {
    self = .string(value)
  }
}

extension OpenAIPredictionContentContent: ExpressibleByArrayLiteral {
