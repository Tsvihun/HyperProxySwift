//
//  OpenAISessionEventAgentSessionEnvironmentFailed.swift
//  HyperProxySwift
//
...
public struct OpenAISessionEventAgentSessionEnvironmentFailed: Codable, Sendable {
  ...
  public var kind: OpenAISessionEventAgentSessionEnvironmentFailedKind
  ...
  public init(
    ...
    sessionId: String,
    turnId: String,
    kind: OpenAISessionEventAgentSessionEnvironmentFailedKind
  ) {
