//
//  OpenAISessionEventAgentSessionEnvironmentConnected.swift
//  HyperProxySwift
//
...
public struct OpenAISessionEventAgentSessionEnvironmentConnected: Codable, Sendable {
  ...
  public var kind: OpenAISessionEventAgentSessionEnvironmentConnectedKind
  ...
  public init(
    ...
    sessionId: String,
    turnId: String,
    kind: OpenAISessionEventAgentSessionEnvironmentConnectedKind
  ) {
