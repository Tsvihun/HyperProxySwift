//
//  OpenAIRealtimeSessionModelAnyOf2.swift
//  HyperProxySwift
//
...
public enum OpenAIRealtimeSessionModelAnyOf2: String, Codable, Hashable, Sendable {
  ...
  case gpt4oRealtimePreview20250603 = "gpt-4o-realtime-preview-2025-06-03"
