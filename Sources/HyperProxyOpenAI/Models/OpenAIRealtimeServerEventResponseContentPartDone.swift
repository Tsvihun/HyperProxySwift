//
//  OpenAIRealtimeServerEventResponseContentPartDone.swift
//  HyperProxySwift
//
...
public struct OpenAIRealtimeServerEventResponseContentPartDone: Codable, Sendable {
  ...
  public var kind: OpenAIRealtimeServerEventResponseContentPartDoneKind
  ...
  public init(
    ...
    responseId: String,
    kind: OpenAIRealtimeServerEventResponseContentPartDoneKind
  ) {
