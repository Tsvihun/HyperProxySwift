//
//  OpenAIRealtimeBetaClientEventConversationItemCreate.swift
//  HyperProxySwift
//
...
public struct OpenAIRealtimeBetaClientEventConversationItemCreate: Codable, Sendable {
  ...
  public var kind: OpenAIRealtimeBetaClientEventConversationItemCreateKind

  public init(
    item: OpenAIRealtimeConversationItem,
    kind: OpenAIRealtimeBetaClientEventConversationItemCreateKind,
    eventId: String? = nil,
