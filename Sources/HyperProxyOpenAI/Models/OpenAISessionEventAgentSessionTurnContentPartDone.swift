//
//  OpenAISessionEventAgentSessionTurnContentPartDone.swift
//  HyperProxySwift
//
...
public struct OpenAISessionEventAgentSessionTurnContentPartDone: Codable, Sendable {
  ...
  public var kind: OpenAISessionEventAgentSessionTurnContentPartDoneKind
  ...
  public init(
    ...
    sessionId: String,
    turnId: String,
    kind: OpenAISessionEventAgentSessionTurnContentPartDoneKind
  ) {
