//
//  OpenAIBetaFunctionShellToolParamEnvironmentAnyOf1.swift
//  HyperProxySwift
//
...
public enum OpenAIBetaFunctionShellToolParamEnvironmentAnyOf1: Codable, Sendable {
  case betaContainerAutoParam(OpenAIBetaContainerAutoParam)
  ...
  public init(from decoder: any Decoder) throws {
    ...
    if let value = try? container.decode(OpenAIBetaContainerAutoParam.self) {
      self = .betaContainerAutoParam(value)
      return
    }
  ...
  public func encode(to encoder: any Encoder) throws {
    ...
    switch self {
    case .betaContainerAutoParam(let value):
