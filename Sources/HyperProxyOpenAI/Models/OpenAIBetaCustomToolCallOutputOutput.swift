//
//  OpenAIBetaCustomToolCallOutputOutput.swift
//  HyperProxySwift
//
...
public enum OpenAIBetaCustomToolCallOutputOutput: Codable, Sendable {
  case string(String)
...
extension OpenAIBetaCustomToolCallOutputOutput: ExpressibleByStringLiteral {
  public init(stringLiteral value: String) {
    self = .string(value)
  }
}

extension OpenAIBetaCustomToolCallOutputOutput: ExpressibleByArrayLiteral {
