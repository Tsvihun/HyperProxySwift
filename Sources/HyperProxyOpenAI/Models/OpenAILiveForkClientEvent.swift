//
//  OpenAILiveForkClientEvent.swift
//  HyperProxySwift
//
...
public enum OpenAILiveForkClientEvent: Codable, Sendable {
  case liveForkSessionStartEvent(OpenAILiveForkSessionStartEvent)
  ...
  public init(from decoder: any Decoder) throws {
    ...
    if let value = try? container.decode(OpenAILiveForkSessionStartEvent.self) {
      self = .liveForkSessionStartEvent(value)
      return
    }
  ...
  public func encode(to encoder: any Encoder) throws {
    ...
    switch self {
    case .liveForkSessionStartEvent(let value):
