//
//  OpenAIPersistedAgentToolResourceFunction.swift
//  HyperProxySwift
//
...
public struct OpenAIPersistedAgentToolResourceFunction: Codable, Sendable {
  ...
  public var kind: OpenAIPersistedAgentToolResourceFunctionKind
  ...
  public init(
    ...
    kind: OpenAIPersistedAgentToolResourceFunctionKind
  ) {
