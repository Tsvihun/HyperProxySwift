...
{
  public var kind: AnthropicBetaManagedAgentsUnrestrictedCredentialNetworkingResponseKind

  public init(
    kind: AnthropicBetaManagedAgentsUnrestrictedCredentialNetworkingResponseKind
  ) {
    self.kind = kind
  }
