//
//  AnthropicBetaManagedAgentsSessionThreadStatusIdleEventStopReason.swift
//  HyperProxySwift
//
...
public enum AnthropicBetaManagedAgentsSessionThreadStatusIdleEventStopReason: Codable, Sendable {
