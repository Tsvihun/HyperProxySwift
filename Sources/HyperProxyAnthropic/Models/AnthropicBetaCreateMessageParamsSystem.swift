//
//  AnthropicBetaCreateMessageParamsSystem.swift
//  HyperProxySwift
//
...
public enum AnthropicBetaCreateMessageParamsSystem: Codable, Sendable {
  case string(String)
...
extension AnthropicBetaCreateMessageParamsSystem: ExpressibleByStringLiteral {
  public init(stringLiteral value: String) {
    self = .string(value)
  }
}

extension AnthropicBetaCreateMessageParamsSystem: ExpressibleByArrayLiteral {
