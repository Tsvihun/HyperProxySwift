//
//  AnthropicBetaCountMessageTokensParamsSystem.swift
//  HyperProxySwift
//
...
public enum AnthropicBetaCountMessageTokensParamsSystem: Codable, Sendable {
  case string(String)
...
extension AnthropicBetaCountMessageTokensParamsSystem: ExpressibleByStringLiteral {
  public init(stringLiteral value: String) {
    self = .string(value)
  }
}

extension AnthropicBetaCountMessageTokensParamsSystem: ExpressibleByArrayLiteral {
