//
//  FireworksChatMessageContent73d26a3d.swift
//  HyperProxySwift
//
...
public enum FireworksChatMessageContent73d26a3d: Codable, Sendable {
  case string(String)
...
extension FireworksChatMessageContent73d26a3d: ExpressibleByStringLiteral {
  public init(stringLiteral value: String) {
    self = .string(value)
  }
}

extension FireworksChatMessageContent73d26a3d: ExpressibleByArrayLiteral {
