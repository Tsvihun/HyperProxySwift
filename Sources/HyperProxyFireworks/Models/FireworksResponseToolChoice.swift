//
//  FireworksResponseToolChoice.swift
//  HyperProxySwift
//
...
public enum FireworksResponseToolChoice: Codable, Sendable {
  case string(String)
...
extension FireworksResponseToolChoice: ExpressibleByStringLiteral {
