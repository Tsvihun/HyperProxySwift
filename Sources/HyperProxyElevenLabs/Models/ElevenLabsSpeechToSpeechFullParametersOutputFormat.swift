//
//  ElevenLabsSpeechToSpeechFullParametersOutputFormat.swift
//  HyperProxySwift
//
...
public enum ElevenLabsSpeechToSpeechFullParametersOutputFormat: String, Codable, Hashable, Sendable
{
