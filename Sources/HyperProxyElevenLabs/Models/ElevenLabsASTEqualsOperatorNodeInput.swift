//
//  ElevenLabsASTEqualsOperatorNodeInput.swift
//  HyperProxySwift
//
...
public final class ElevenLabsASTEqualsOperatorNodeInput: Codable, @unchecked Sendable {
  ...
  public init(
    ...
    kind: ElevenLabsEqOperatorKind? = nil
  ) {
    self.left = left
    self.right = right
    self.kind = kind
