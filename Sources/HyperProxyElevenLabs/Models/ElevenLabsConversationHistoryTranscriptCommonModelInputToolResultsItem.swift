//
//  ElevenLabsConversationHistoryTranscriptCommonModelInputToolResultsItem.swift
//  HyperProxySwift
//
...
public enum ElevenLabsConversationHistoryTranscriptCommonModelInputToolResultsItem: Codable,
  Sendable
{
