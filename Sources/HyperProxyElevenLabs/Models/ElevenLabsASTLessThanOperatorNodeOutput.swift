//
//  ElevenLabsASTLessThanOperatorNodeOutput.swift
//  HyperProxySwift
//
...
public final class ElevenLabsASTLessThanOperatorNodeOutput: Codable, @unchecked Sendable {
  ...
  public init(
    ...
    kind: ElevenLabsLtOperatorKind = .ltOperator
  ) {
    self.left = left
    self.right = right
    self.kind = kind
