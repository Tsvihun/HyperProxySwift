//
//  ElevenLabsMCPServerConfigUpdateRequestModelRequestHeadersAnyOf1Value.swift
//  HyperProxySwift
//
...
public enum ElevenLabsMCPServerConfigUpdateRequestModelRequestHeadersAnyOf1Value: Codable, Sendable
{
  case string(String)
...
extension ElevenLabsMCPServerConfigUpdateRequestModelRequestHeadersAnyOf1Value:
