//
//  ElevenLabsWorkflowPhoneNumberNodeModelOutputTransferDestination.swift
//  HyperProxySwift
//
...
public enum ElevenLabsWorkflowPhoneNumberNodeModelOutputTransferDestination: Codable, Sendable {
