//
//  ElevenLabsGetKnowledgeBaseSummaryFolderResponseModelDependentAgentsItem.swift
//  HyperProxySwift
//
...
public enum ElevenLabsGetKnowledgeBaseSummaryFolderResponseModelDependentAgentsItem: Codable,
  Sendable
{
