//
//  ElevenLabsMCPServerConfigInputRequestMetaValue.swift
//  HyperProxySwift
//
...
public enum ElevenLabsMCPServerConfigInputRequestMetaValue: Codable, Sendable {
  case boolean(Bool)
  case integer(Int)
  case number(Double)
  case string(String)
...
extension ElevenLabsMCPServerConfigInputRequestMetaValue: ExpressibleByIntegerLiteral {
  public init(integerLiteral value: Int) {
    self = .integer(value)
  }
}

extension ElevenLabsMCPServerConfigInputRequestMetaValue: ExpressibleByStringLiteral {
