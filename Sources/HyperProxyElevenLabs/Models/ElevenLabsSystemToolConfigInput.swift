//
//  ElevenLabsSystemToolConfigInput.swift
//  HyperProxySwift
//
...
public struct ElevenLabsSystemToolConfigInput: Codable, Sendable {
  ...
  public var params: ElevenLabsSystemToolConfigInputParams
  ...
  public init(
    name: String,
    params: ElevenLabsSystemToolConfigInputParams,
