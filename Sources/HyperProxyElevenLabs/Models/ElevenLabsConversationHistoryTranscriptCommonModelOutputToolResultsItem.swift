//
//  ElevenLabsConversationHistoryTranscriptCommonModelOutputToolResultsItem.swift
//  HyperProxySwift
//
...
public enum ElevenLabsConversationHistoryTranscriptCommonModelOutputToolResultsItem: Codable,
  Sendable
{
