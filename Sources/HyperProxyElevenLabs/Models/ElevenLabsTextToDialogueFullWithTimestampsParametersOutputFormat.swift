//
//  ElevenLabsTextToDialogueFullWithTimestampsParametersOutputFormat.swift
//  HyperProxySwift
//
...
public enum ElevenLabsTextToDialogueFullWithTimestampsParametersOutputFormat: String, Codable,
  Hashable, Sendable
{
