//
//  ElevenLabsMCPServerConfigOutputRequestMetaValue.swift
//  HyperProxySwift
//
...
public enum ElevenLabsMCPServerConfigOutputRequestMetaValue: Codable, Sendable {
  case boolean(Bool)
  case integer(Int)
  case number(Double)
  case string(String)
...
extension ElevenLabsMCPServerConfigOutputRequestMetaValue: ExpressibleByIntegerLiteral {
  public init(integerLiteral value: Int) {
    self = .integer(value)
  }
}

extension ElevenLabsMCPServerConfigOutputRequestMetaValue: ExpressibleByStringLiteral {
