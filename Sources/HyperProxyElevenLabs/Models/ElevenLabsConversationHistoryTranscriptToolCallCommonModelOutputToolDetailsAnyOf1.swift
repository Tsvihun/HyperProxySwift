//
//  ElevenLabsConversationHistoryTranscriptToolCallCommonModelOutputToolDetailsAnyOf1.swift
//  HyperProxySwift
//
...
public enum ElevenLabsConversationHistoryTranscriptToolCallCommonModelOutputToolDetailsAnyOf1:
  Codable, Sendable
{
  ...
  case conversationHistoryTranscriptToolCallApiIntegrationWebhookDetailsOutput(
    ElevenLabsConversationHistoryTranscriptToolCallApiIntegrationWebhookDetailsOutput)
  ...
  public init(from decoder: any Decoder) throws {
    ...
    self = .conversationHistoryTranscriptToolCallApiIntegrationWebhookDetailsOutput(
      try container.decode(
        ElevenLabsConversationHistoryTranscriptToolCallApiIntegrationWebhookDetailsOutput.self))
  }
  ...
  public func encode(to encoder: any Encoder) throws {
    ...
    case .conversationHistoryTranscriptToolCallMCPDetails(let value):
      try container.encode(value)
    case .conversationHistoryTranscriptToolCallApiIntegrationWebhookDetailsOutput(let value):
      try container.encode(value)
    }
  }
}
