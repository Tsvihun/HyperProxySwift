//
//  ElevenLabsWebhookToolApiSchemaConfigInputRequestHeadersValue.swift
//  HyperProxySwift
//
...
public enum ElevenLabsWebhookToolApiSchemaConfigInputRequestHeadersValue: Codable, Sendable {
  case string(String)
...
extension ElevenLabsWebhookToolApiSchemaConfigInputRequestHeadersValue: ExpressibleByStringLiteral {
