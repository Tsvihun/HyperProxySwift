//
//  ElevenLabsTextToSpeechFullWithTimestampsParametersOutputFormat.swift
//  HyperProxySwift
//
...
public enum ElevenLabsTextToSpeechFullWithTimestampsParametersOutputFormat: String, Codable,
  Hashable, Sendable
{
