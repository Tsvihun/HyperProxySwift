//
//  ElevenLabsConversationHistoryTranscriptSystemToolResultCommonModelInputResultAnyOf1.swift
//  HyperProxySwift
//
...
public enum ElevenLabsConversationHistoryTranscriptSystemToolResultCommonModelInputResultAnyOf1:
  Codable, Sendable
{
  ...
  case transferToAgentToolResultSuccessModelInput(
    ElevenLabsTransferToAgentToolResultSuccessModelInput)
  ...
  public init(from decoder: any Decoder) throws {
    ...
    if let value = try? container.decode(ElevenLabsTransferToAgentToolResultSuccessModelInput.self)
    {
      self = .transferToAgentToolResultSuccessModelInput(value)
      return
    }
  ...
  public func encode(to encoder: any Encoder) throws {
    ...
    case .languageDetectionToolResultModel(let value):
      try container.encode(value)
    case .transferToAgentToolResultSuccessModelInput(let value):
      try container.encode(value)
