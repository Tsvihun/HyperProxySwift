//
//  ElevenLabsMCPServerConfigInputRequestHeadersValue.swift
//  HyperProxySwift
//
...
public enum ElevenLabsMCPServerConfigInputRequestHeadersValue: Codable, Sendable {
  case string(String)
...
extension ElevenLabsMCPServerConfigInputRequestHeadersValue: ExpressibleByStringLiteral {
