//
//  ElevenLabsWebhookToolApiSchemaConfigOutputRequestHeadersValue.swift
//  HyperProxySwift
//
...
public enum ElevenLabsWebhookToolApiSchemaConfigOutputRequestHeadersValue: Codable, Sendable {
  case string(String)
...
extension ElevenLabsWebhookToolApiSchemaConfigOutputRequestHeadersValue: ExpressibleByStringLiteral
{
