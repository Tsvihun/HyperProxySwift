//
//  ElevenLabsMCPServerConfigOutputRequestHeadersValue.swift
//  HyperProxySwift
//
...
public enum ElevenLabsMCPServerConfigOutputRequestHeadersValue: Codable, Sendable {
  case string(String)
...
extension ElevenLabsMCPServerConfigOutputRequestHeadersValue: ExpressibleByStringLiteral {
