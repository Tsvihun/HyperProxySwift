//
//  OpenRouterDecisionsChoiceQuestionInstructions.swift
//  HyperProxySwift
//
...
public enum OpenRouterDecisionsChoiceQuestionInstructions: Codable, Sendable {
  case string(String)
...
extension OpenRouterDecisionsChoiceQuestionInstructions: ExpressibleByStringLiteral {
