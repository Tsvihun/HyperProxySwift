//
//  OpenRouterObservabilityGrafanaDestination.swift
//  HyperProxySwift
//
...
public struct OpenRouterObservabilityGrafanaDestination: Codable, Sendable {
  ...
  public var kind: OpenRouterObservabilityGrafanaDestinationKind
  ...
  public init(
    ...
    samplingRate: Double,
    kind: OpenRouterObservabilityGrafanaDestinationKind,
    updatedAt: String,
    workspaceId: String
  ) {
