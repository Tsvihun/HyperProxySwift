//
//  OpenRouterObservabilityWeaveDestination.swift
//  HyperProxySwift
//
...
public struct OpenRouterObservabilityWeaveDestination: Codable, Sendable {
  ...
  public var kind: OpenRouterObservabilityWeaveDestinationKind
  ...
  public init(
    ...
    samplingRate: Double,
    kind: OpenRouterObservabilityWeaveDestinationKind,
    updatedAt: String,
    workspaceId: String
  ) {
