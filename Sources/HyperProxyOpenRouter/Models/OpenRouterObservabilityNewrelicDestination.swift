//
//  OpenRouterObservabilityNewrelicDestination.swift
//  HyperProxySwift
//
...
public struct OpenRouterObservabilityNewrelicDestination: Codable, Sendable {
  ...
  public var kind: OpenRouterObservabilityNewrelicDestinationKind
  ...
  public init(
    ...
    samplingRate: Double,
    kind: OpenRouterObservabilityNewrelicDestinationKind,
    updatedAt: String,
    workspaceId: String
  ) {
