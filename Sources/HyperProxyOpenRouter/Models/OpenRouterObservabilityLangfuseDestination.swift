//
//  OpenRouterObservabilityLangfuseDestination.swift
//  HyperProxySwift
//
...
public struct OpenRouterObservabilityLangfuseDestination: Codable, Sendable {
  ...
  public var kind: OpenRouterObservabilityLangfuseDestinationKind
  ...
  public init(
    ...
    samplingRate: Double,
    kind: OpenRouterObservabilityLangfuseDestinationKind,
    updatedAt: String,
    workspaceId: String
  ) {
