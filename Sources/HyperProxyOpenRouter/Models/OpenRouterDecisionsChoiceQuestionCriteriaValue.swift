//
//  OpenRouterDecisionsChoiceQuestionCriteriaValue.swift
//  HyperProxySwift
//
...
public enum OpenRouterDecisionsChoiceQuestionCriteriaValue: Codable, Sendable {
  case string(String)
...
extension OpenRouterDecisionsChoiceQuestionCriteriaValue: ExpressibleByStringLiteral {
