//
//  OpenRouterAnthropicCitationSearchResultLocation.swift
//  HyperProxySwift
//
...
public struct OpenRouterAnthropicCitationSearchResultLocation: Codable, Sendable {
  ...
  public var kind: OpenRouterAnthropicCitationSearchResultLocationKind
  ...
  public init(
    ...
    startBlockIndex: Int,
    title: String,
    kind: OpenRouterAnthropicCitationSearchResultLocationKind
  ) {
