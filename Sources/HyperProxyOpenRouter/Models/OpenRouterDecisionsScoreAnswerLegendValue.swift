//
//  OpenRouterDecisionsScoreAnswerLegendValue.swift
//  HyperProxySwift
//
...
public enum OpenRouterDecisionsScoreAnswerLegendValue: Codable, Sendable {
  case string(String)
...
extension OpenRouterDecisionsScoreAnswerLegendValue: ExpressibleByStringLiteral {
