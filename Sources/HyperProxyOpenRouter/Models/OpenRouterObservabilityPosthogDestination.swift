//
//  OpenRouterObservabilityPosthogDestination.swift
//  HyperProxySwift
//
...
public struct OpenRouterObservabilityPosthogDestination: Codable, Sendable {
  ...
  public var kind: OpenRouterObservabilityPosthogDestinationKind
  ...
  public init(
    ...
    samplingRate: Double,
    kind: OpenRouterObservabilityPosthogDestinationKind,
    updatedAt: String,
    workspaceId: String
  ) {
