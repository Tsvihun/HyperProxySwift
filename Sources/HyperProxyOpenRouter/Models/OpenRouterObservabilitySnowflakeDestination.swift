//
//  OpenRouterObservabilitySnowflakeDestination.swift
//  HyperProxySwift
//
...
public struct OpenRouterObservabilitySnowflakeDestination: Codable, Sendable {
  ...
  public var kind: OpenRouterObservabilitySnowflakeDestinationKind
  ...
  public init(
    ...
    samplingRate: Double,
    kind: OpenRouterObservabilitySnowflakeDestinationKind,
    updatedAt: String,
    workspaceId: String
  ) {
