//
//  OpenRouterAnthropicCitationContentBlockLocation.swift
//  HyperProxySwift
//
...
public struct OpenRouterAnthropicCitationContentBlockLocation: Codable, Sendable {
  ...
  public var kind: OpenRouterAnthropicCitationContentBlockLocationKind
  ...
  public init(
    ...
    fileId: String,
    startBlockIndex: Int,
    kind: OpenRouterAnthropicCitationContentBlockLocationKind
  ) {
