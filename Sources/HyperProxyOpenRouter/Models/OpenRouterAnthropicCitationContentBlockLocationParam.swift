//
//  OpenRouterAnthropicCitationContentBlockLocationParam.swift
//  HyperProxySwift
//
...
public struct OpenRouterAnthropicCitationContentBlockLocationParam: Codable, Sendable {
  ...
  public var kind: OpenRouterAnthropicCitationContentBlockLocationParamKind
  ...
  public init(
    ...
    endBlockIndex: Int,
    startBlockIndex: Int,
    kind: OpenRouterAnthropicCitationContentBlockLocationParamKind
  ) {
