//
//  OpenRouterDecisionsNoulQuestionInstructions.swift
//  HyperProxySwift
//
...
public enum OpenRouterDecisionsNoulQuestionInstructions: Codable, Sendable {
  case string(String)
...
extension OpenRouterDecisionsNoulQuestionInstructions: ExpressibleByStringLiteral {
