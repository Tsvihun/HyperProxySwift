//
//  OpenRouterObservabilitySentryDestination.swift
//  HyperProxySwift
//
...
public struct OpenRouterObservabilitySentryDestination: Codable, Sendable {
  ...
  public var kind: OpenRouterObservabilitySentryDestinationKind
  ...
  public init(
    ...
    samplingRate: Double,
    kind: OpenRouterObservabilitySentryDestinationKind,
    updatedAt: String,
    workspaceId: String
  ) {
