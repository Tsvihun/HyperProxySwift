//
//  OpenRouterBaseReasoningSummaryPartDoneEvent.swift
//  HyperProxySwift
//
...
public struct OpenRouterBaseReasoningSummaryPartDoneEvent: Codable, Sendable {
  ...
  public var kind: OpenRouterBaseReasoningSummaryPartDoneEventKind
  ...
  public init(
    ...
    sequenceNumber: Int,
    summaryIndex: Int,
    kind: OpenRouterBaseReasoningSummaryPartDoneEventKind
  ) {
    self.itemId = itemId
