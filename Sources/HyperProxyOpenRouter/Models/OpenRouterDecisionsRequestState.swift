//
//  OpenRouterDecisionsRequestState.swift
//  HyperProxySwift
//
...
public enum OpenRouterDecisionsRequestState: Codable, Sendable {
  case string(String)
...
extension OpenRouterDecisionsRequestState: ExpressibleByStringLiteral {
