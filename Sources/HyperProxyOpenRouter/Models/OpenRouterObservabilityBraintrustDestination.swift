//
//  OpenRouterObservabilityBraintrustDestination.swift
//  HyperProxySwift
//
...
public struct OpenRouterObservabilityBraintrustDestination: Codable, Sendable {
  ...
  public var kind: OpenRouterObservabilityBraintrustDestinationKind
  ...
  public init(
    ...
    samplingRate: Double,
    kind: OpenRouterObservabilityBraintrustDestinationKind,
    updatedAt: String,
    workspaceId: String
  ) {
