//
//  OpenRouterObservabilityOtelCollectorDestination.swift
//  HyperProxySwift
//
...
public struct OpenRouterObservabilityOtelCollectorDestination: Codable, Sendable {
  ...
  public var kind: OpenRouterObservabilityOtelCollectorDestinationKind
  ...
  public init(
    ...
    samplingRate: Double,
    kind: OpenRouterObservabilityOtelCollectorDestinationKind,
    updatedAt: String,
    workspaceId: String
  ) {
