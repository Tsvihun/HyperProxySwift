//
//  OpenRouterObservabilityArizeDestination.swift
//  HyperProxySwift
//
...
public struct OpenRouterObservabilityArizeDestination: Codable, Sendable {
  ...
  public var kind: OpenRouterObservabilityArizeDestinationKind
  ...
  public init(
    ...
    samplingRate: Double,
    kind: OpenRouterObservabilityArizeDestinationKind,
    updatedAt: String,
    workspaceId: String
  ) {
