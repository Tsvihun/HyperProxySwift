//
//  OpenRouterChatSystemMessageContent.swift
//  HyperProxySwift
//
...
public enum OpenRouterChatSystemMessageContent: Codable, Sendable {
  case string(String)
...
extension OpenRouterChatSystemMessageContent: ExpressibleByStringLiteral {
  public init(stringLiteral value: String) {
    self = .string(value)
  }
}

extension OpenRouterChatSystemMessageContent: ExpressibleByArrayLiteral {
