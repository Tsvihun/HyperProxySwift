//
//  OpenRouterObservabilityClickhouseDestination.swift
//  HyperProxySwift
//
...
public struct OpenRouterObservabilityClickhouseDestination: Codable, Sendable {
  ...
  public var kind: OpenRouterObservabilityClickhouseDestinationKind
  ...
  public init(
    ...
    samplingRate: Double,
    kind: OpenRouterObservabilityClickhouseDestinationKind,
    updatedAt: String,
    workspaceId: String
  ) {
