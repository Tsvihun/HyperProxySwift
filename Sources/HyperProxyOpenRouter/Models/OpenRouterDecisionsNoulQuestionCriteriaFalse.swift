//
//  OpenRouterDecisionsNoulQuestionCriteriaFalse.swift
//  HyperProxySwift
//
...
public enum OpenRouterDecisionsNoulQuestionCriteriaFalse: Codable, Sendable {
  case string(String)
...
extension OpenRouterDecisionsNoulQuestionCriteriaFalse: ExpressibleByStringLiteral {
