//
//  OpenRouterImageGenerationProviderPreferencesIgnoreItem.swift
//  HyperProxySwift
//
...
public enum OpenRouterImageGenerationProviderPreferencesIgnoreItem: RawRepresentable, Codable,
  Hashable, Sendable
{
  case modal
  case akashML
