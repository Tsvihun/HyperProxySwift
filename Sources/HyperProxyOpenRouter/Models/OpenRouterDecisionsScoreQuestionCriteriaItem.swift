//
//  OpenRouterDecisionsScoreQuestionCriteriaItem.swift
//  HyperProxySwift
//
...
public enum OpenRouterDecisionsScoreQuestionCriteriaItem: Codable, Sendable {
  case string(String)
...
extension OpenRouterDecisionsScoreQuestionCriteriaItem: ExpressibleByStringLiteral {
