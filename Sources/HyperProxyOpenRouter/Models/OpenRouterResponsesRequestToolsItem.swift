//
//  OpenRouterResponsesRequestToolsItem.swift
//  HyperProxySwift
//
...
public enum OpenRouterResponsesRequestToolsItem: Codable, Sendable {
  case responsesRequestToolsItemAnyOf1(OpenRouterResponsesRequestToolsItemAnyOf1)
  ...
  public init(from decoder: any Decoder) throws {
    ...
    if let value = try? container.decode(OpenRouterResponsesRequestToolsItemAnyOf1.self) {
      self = .responsesRequestToolsItemAnyOf1(value)
      return
    }
  ...
  public func encode(to encoder: any Encoder) throws {
    ...
    switch self {
    case .responsesRequestToolsItemAnyOf1(let value):
