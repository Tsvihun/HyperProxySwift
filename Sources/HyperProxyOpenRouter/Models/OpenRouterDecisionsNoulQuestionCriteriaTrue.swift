//
//  OpenRouterDecisionsNoulQuestionCriteriaTrue.swift
//  HyperProxySwift
//
...
public enum OpenRouterDecisionsNoulQuestionCriteriaTrue: Codable, Sendable {
  case string(String)
...
extension OpenRouterDecisionsNoulQuestionCriteriaTrue: ExpressibleByStringLiteral {
