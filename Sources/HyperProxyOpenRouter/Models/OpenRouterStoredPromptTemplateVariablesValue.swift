//
//  OpenRouterStoredPromptTemplateVariablesValue.swift
//  HyperProxySwift
//
...
public enum OpenRouterStoredPromptTemplateVariablesValue: Codable, Sendable {
  case string(String)
...
extension OpenRouterStoredPromptTemplateVariablesValue: ExpressibleByStringLiteral {
