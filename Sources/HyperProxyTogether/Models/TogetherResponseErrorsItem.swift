//
//  TogetherResponseErrorsItem.swift
//  HyperProxySwift
//
...
public enum TogetherResponseErrorsItem: Codable, Sendable {
  case string(String)
...
extension TogetherResponseErrorsItem: ExpressibleByStringLiteral {
