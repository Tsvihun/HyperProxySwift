Pod::Spec.new do |s|
  s.name = 'HyperProxyOpenRouter'
  s.version = '0.4.1'
  s.summary = 'Complete OpenRouter API module for HyperProxySwift.'
  ...
  s.source_files = 'Sources/HyperProxyOpenRouter/**/*.swift'
  s.dependency 'HyperProxyCore', '= 0.4.1'; s.dependency 'HyperProxyProviders', '= 0.4.1'
